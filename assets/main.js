...
(function () {
  ...
  window.filterCards = function () { applyFilters(); };
  ...
  function applyFilters() {
    ...
    document.querySelectorAll('.card').forEach(function (card) {
      ...
      var matchesText = !query || title.indexOf(query) !== -1 || body.indexOf(query) !== -1;
  ...
  window.scrollToCard = function (id) {
    ...
    var link = document.querySelector('.sidebar-link[data-target="' + id + '"]');
  ...
  if (typeof IntersectionObserver !== 'undefined') {
    ...
    document.querySelectorAll('.card[id]').forEach(function (c) { observer.observe(c); });
  }
})();
